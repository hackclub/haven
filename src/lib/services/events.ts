...
/**
 * Start the recurring sync. Called for its side effect from src/middleware.ts,
 * which is the one module Astro loads on the way to serving anything, so the
